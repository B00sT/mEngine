...
void mEngine::mInit(int width_, int height_, const char *font_fname, bool fullScreen_, void(*draw_screen_func_)(void))
{
	...
	flags = SDL_OPENGL | (fullScreen_ ? SDL_FULLSCREEN : 0);
	...
	set3D();
	Font = new MFont(font_fname, 1.0f, -0.2f, 32, 0);
}
